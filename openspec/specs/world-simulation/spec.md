...
- **THEN** a construction order for a Bed is created at that tile and, once complete, a Bed building entity exists at that tile with no occupant
...
- **WHEN** a colonist interacts with a completed BerryBush building from an orthogonally adjacent tile and the bush has berries remaining
...
- **WHEN** a colonist interacts with a completed Bed building while standing on the bed tile and holding the bed reservation
